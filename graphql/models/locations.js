...
/**
 * Method to get all locationInformation
 */

Locations.getLocationsInformation = ({ status, pattern, sort, pageNumber, limit, sortKey,
                                       customerIds, collection, deleted }) => {
