...
module.exports.generatePalette = (config) => {
  return new Promise((resolve, reject) => {
    ...
    paletteFinal.rgb50 = hexToRgb(paletteFinal['50'])
    paletteFinal.rgb100 = hexToRgb(paletteFinal['100'])
    paletteFinal.rgb200 = hexToRgb(paletteFinal['200'])
    paletteFinal.rgb300 = hexToRgb(paletteFinal['300'])
    paletteFinal.rgb400 = hexToRgb(paletteFinal['400'])
    paletteFinal.rgb500 = hexToRgb(paletteFinal['500'])
    paletteFinal.rgb600 = hexToRgb(paletteFinal['600'])
    paletteFinal.rgb700 = hexToRgb(paletteFinal['700'])
    paletteFinal.rgb800 = hexToRgb(paletteFinal['800'])
    paletteFinal.rgb900 = hexToRgb(paletteFinal['900'])

    resolve(paletteFinal)
  })
}
