...
const getCertNotAfter = (notBefore) => {
    let ninetyDaysLater = new Date(notBefore.getTime());
    let year = ninetyDaysLater.getFullYear() + 50;
...
let createDeviceCert = (certificatePem, encryptedPrivateKey, thingName) => {
    let rootCAObject = {certificate: certificatePem, privateKey: encryptedPrivateKey}
